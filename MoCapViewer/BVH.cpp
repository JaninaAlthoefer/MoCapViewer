#include "../../MoCapViewer/MoCapViewer/BVH.h"
#include <iostream>
#include <sstream>
...
bool BVH::load(wchar_t *name)
{
	...
	bool res = loadHierarchy(&file, NULL, root);
...
bool BVH::loadHierarchy(std::ifstream *stream, Joint *parent, Joint *out)
{
	bool isEnd = false;
...
bool BVH::loadMotion(std::ifstream *stream, Motion *out)
{
	std::string line;
